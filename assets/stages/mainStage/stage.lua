function onCreateStage(stage)
    ...
    stageback:loadTexture("assets/stages/stage/stageback.png")
    stageback.scrollFactor.x = 0.9
    stageback.scrollFactor.y = 0.9
    stage:add(stageback)

    local stagefront = Sprite.new(-650, 600)
    stagefront:loadTexture("assets/stages/stage/stagefront.png")
    ...
    stagecurtains:loadTexture("assets/stages/stage/stagecurtains.png")
